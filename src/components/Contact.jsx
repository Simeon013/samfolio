      ...
      <div className="max-w-6xl mx-auto px-4">
        <FadeInUp>
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-6 font-heading tracking-tight text-[var(--color-text-primary)]">Démarrons un Projet</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <FadeInUp delay={0.2} className="h-full">
            <div className="bg-[var(--color-bg-tertiary)] text-white p-10 rounded-[2.5rem] relative overflow-hidden h-full flex flex-col justify-between shadow-2xl">
